...
- [ ] Pubblicare e rileggere il piano quote a otto voci: Starter Pack e cauzione rimborsabile sempre solo contanti/in loco, lenzuola e asciugamani inclusi nello Starter Pack; le altre voci partono da “da definire”. Nessun link/IBAN/contatto nell'area equipaggio.
- [ ] Pubblicare e testare il Preventivo barca privato: costi aggregati, Starter Pack, assicurazione, cauzione e partecipanti paganti; divisore cauzione separato anche per collaboratori gratuiti, formula esplicita senza skipper nel divisore, dinette al 65% o a prezzo fisso con cabina ricavata dalla differenza, nessuna voce cena, nessun profitto, nessun accesso equipaggio/organizzazione e nessun incasso automatico.
...
- [ ] Test piano quote: skipper salva solo le otto voci fisse; Starter Pack è sempre cash/in loco, lenzuola/asciugamani sono inclusi nel Pack e la cauzione rimborsabile è sempre cash/in loco. Le altre voci mantengono gli stati previsti. Crew legge il piano solo dopo briefing corrente, senza dati di incasso.
...
- [ ] Test Preventivo barca: `costPlan/default` v4 con soli importi fittizi, 1–30 ospiti paganti e persone che portano la cauzione, posti dinette paganti, percentuale 1–100 oppure prezzo fisso coerente; skipper legge/salva/rilegge la propria barca, mentre organizzatore, crew, outsider, `list` e `delete` sono negati. Verificare quota cabina, dinette al 65% predefinito e a prezzo fisso, esclusione skipper/staff gratuiti dal divisore delle quote, divisore cauzione separato anche per staff gratuito, Starter Pack/cauzione cash-in-loco e che il bilancio usi solo richieste `cost_recovery` verificate manualmente.
