...
- [ ] Pubblicare e rileggere il piano quote: le cinque quote principali restano separate; le dieci voci descrivono le spese del weekend. Starter Pack sempre cash/in loco, anche quando il suo valore è già dentro il charter; lenzuola e asciugamani inclusi nello Starter Pack; le altre voci partono da “da definire”. Nessun link/IBAN/contatto nell'area equipaggio.
- [ ] Pubblicare e testare il Preventivo barca privato v6: costi aggregati, Starter Pack, assicurazione, cauzione e partecipanti paganti; il Pack può essere interno o esterno al charter e ripartito come totale o fisso/persona, ma resta cash; divisore cauzione separato anche per collaboratori gratuiti, formula esplicita senza skipper nel divisore, dinette al 65% o a prezzo fisso con cabina ricavata dopo lo scorporo del Pack, nessuna voce cena, nessun profitto, nessun accesso equipaggio/organizzazione e nessun incasso automatico.
...
- [ ] Test piano quote: skipper salva le cinque quote automatiche e le dieci voci del weekend; Starter Pack è sempre cash/in loco, anche se già nel charter; lenzuola/asciugamani sono inclusi nel Pack e la cauzione rimborsabile è sempre cash/in loco. Le altre voci mantengono gli stati previsti. Crew legge il piano solo dopo briefing corrente, senza dati di incasso.
...
- [ ] Test Preventivo barca: `costPlan/default` v6 con soli importi fittizi, 1–30 ospiti paganti e persone che portano la cauzione, posti dinette paganti, percentuale 1–100 oppure prezzo fisso coerente; skipper legge/salva/rilegge la propria barca, mentre organizzatore, crew, outsider, `list` e `delete` sono negati. Verificare quota cabina, dinette al 65% predefinito e a prezzo fisso, esclusione skipper/staff gratuiti dal divisore delle quote, divisore cauzione separato anche per staff gratuito, entrambe le provenienze del Pack (interno/esterno charter) e i due metodi di riparto (totale/fisso), con Pack sempre cash-in-loco, e che il bilancio usi solo richieste `cost_recovery` verificate manualmente.
