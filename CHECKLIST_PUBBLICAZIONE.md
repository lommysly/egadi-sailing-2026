...
- [ ] Piano quote equipaggio: fino al completamento della migrazione dello schema sicuro, il salvataggio del Preventivo barca non riscrive più automaticamente le dieci voci già pubblicate all'equipaggio. Il preventivo, le proiezioni e le quote automatiche restano operativi; non modificare manualmente il piano quote finché non viene verificato il nuovo schema.
