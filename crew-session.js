...
// Spostato in stale-script.js così anche area.js (sessione skipper, non
// crew) può usarlo senza importare tutta la logica di accesso equipaggio.
export { isScriptStale, watchForStaleScript } from './stale-script.js?v=20260925-extract-v1';
