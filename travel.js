...
import { crewAccessErrorMessage, crewAccessUrl, db, isScriptStale, personalAreaUrl, profileUrl, startCrewAreaSession, watchForStaleScript, withSaveRetry } from './crew-session.js?v=20260925-reserved-area-nav-v1';
