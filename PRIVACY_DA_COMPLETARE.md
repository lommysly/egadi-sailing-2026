...
| Dati Crew List | Anagrafica, documento, ruolo/cabina, contatti, consenso di consegna al charter e richieste di contributo descrittive. Verificare se ogni campo è davvero necessario. |
...
| Destinatari | Skipper della barca, organizzazione, charter e, se applicabile, autorità competente; indicare Firebase/Google, GitHub Pages e WhatsApp soltanto per i ruoli effettivamente svolti. |
| Conservazione | Definire data o criterio separato per dati Firestore, account Firebase tecnici, indice telefonico, PDF scaricati e messaggi WhatsApp. |
...
2. Entro il termine dichiarato, l'incaricato esporta se necessario i dati consentiti e cancella Crew List, inviti, `crewAccess`, `crewLoginIndex`, richieste e file locali non più necessari.
