...
| Arrivi, partenze e transfer | Per ciascuna tratta: città / zona, aeroporto reale, data, orario di riferimento, orari aggiuntivi facoltativi, volo, bagagli e disponibilità a cercare/offrire un passaggio. Se si offre un'auto, limitarsi a auto propria o a noleggio, posti e spazio bagagli: escludere targa, patente, carta di credito, prezzo, pagamenti e assicurazione. Per aeroporto ↔ Marsala dichiarare che organizzatore e società transfer incaricata ricevono i dati necessari a gestire il mezzo e contattare la persona. Per i passaggi fra partecipanti, prevedere scelta facoltativa per singola tratta, doppia conferma prima di mostrare WhatsApp e revoca. Non creare elenchi pubblici o URL con contatti. |
...
| Destinatari | Skipper della barca, organizzazione, charter, società transfer incaricata per le sole tratte aeroportuali e, se applicabile, autorità competente; indicare Firebase/Google, GitHub Pages e WhatsApp, usato per l'invio diretto di dettagli scelti dallo skipper, soltanto per i ruoli effettivamente svolti. |
| Conservazione | Definire data o criterio separato per dati Firestore, tratte transfer, profilo/tag incasso, richieste, account Firebase tecnici, indice telefonico, PDF scaricati e messaggi WhatsApp. |
...
2. Entro il termine dichiarato, l'incaricato esporta se necessario i dati consentiti e cancella Crew List, inviti, `crewAccess`, `crewLoginIndex`, tratte transfer, profilo/tag incasso, richieste e file locali non più necessari.
