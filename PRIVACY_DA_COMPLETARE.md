...
| Conservazione | Definire data o criterio separato per dati Firestore, dossier skipper, piano quote, cassa skipper privata, profilo privato di incasso e relative istruzioni, richieste, account Firebase tecnici, indice telefonico, PDF scaricati e messaggi WhatsApp. La cassa skipper e il dossier non sono eliminabili dall'area: definire una procedura amministrativa autorizzata per la cancellazione a fine conservazione. |
...
2. Entro il termine dichiarato, l'incaricato esporta se necessario i dati consentiti e cancella Crew List, dossier skipper, inviti, `crewAccess`, `crewLoginIndex`, piano quote, cassa skipper privata, profilo privato di incasso e relative istruzioni, richieste e file locali non più necessari. Per `costPlan/default` e `skipperProfile/default` usare la procedura amministrativa autorizzata: le Rules non consentono l'eliminazione dall'area skipper.
