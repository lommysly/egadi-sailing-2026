...
Nel modulo equipaggio, la conferma di un volo richiede una scelta esplicita per il collegamento aeroporto ↔ Marsala: transfer organizzato oppure autonomia. Se la persona non lo sa ancora, salva una bozza. Per chiedere il transfer deve inoltre dare il consenso dedicato. La card distingue viaggio confermato, transfer richiesto e collegamento non indicato; i pulsanti e i messaggi di esito nominano sempre andata o rientro. Una bozza con transfer e consenso è visibile al coordinatore solo quando è indicato anche l'aeroporto Trapani (TPS) o Palermo (PMO), come previsto dal processo server. Il test locale mobile in Chromium e WebKit ha verificato che scelta e consenso restano nel form anche passando a un'altra scheda; resta separata la prova autenticata dal dispositivo della partecipante.
