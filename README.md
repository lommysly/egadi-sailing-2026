...
boats/{skipperUid}
  ...
  contributionPlan/default
    items: { berth, starter_pack, linen_towels, protection_insurance,
             ...
             refundable_deposit }
    ogni voce: { state, amountCents, description }
...
| Starter Pack · lenzuola/asciugamani, SUP e fuoribordo | quota cash/in loco; valore già compreso nel charter oppure esterno |
